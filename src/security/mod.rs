...
#[allow(unused_imports)] // resolved_addrs_blocked is used only by the engine feature
pub use ip_filter::{
    is_blocked_target, is_source_ip_allowed, resolve_and_validate_host, resolved_addrs_blocked,
    split_host_port,
};
